import { c as createInvalidVariablesError, g as getEnv$1, s as setOnSetGetEnv } from './runtime_DLbcSFIo.mjs';
...
TIENDANUBE_ACCESS_TOKEN = _internalGetSecret("TIENDANUBE_ACCESS_TOKEN");
TIENDANUBE_USER_ID = _internalGetSecret("TIENDANUBE_USER_ID");
...
let TIENDANUBE_ACCESS_TOKEN = _internalGetSecret("TIENDANUBE_ACCESS_TOKEN");
let TIENDANUBE_USER_ID = _internalGetSecret("TIENDANUBE_USER_ID");

export { GOOGLE_SERVICE_ACCOUNT_PRIVATE_KEY as G, SENDER_NET_ACCESS_TOKEN as S, TIENDANUBE_USER_ID as T, GOOGLE_SERVICE_ACCOUNT_EMAIL as a, GOOGLE_CALENDAR_ID as b, GOOGLE_APP_PASSWORD as c, GOOGLE_SHEETS_SHEET_NAME as d, GOOGLE_SHEETS_SPREADSHEET_ID as e, TIENDANUBE_ACCESS_TOKEN as f };
